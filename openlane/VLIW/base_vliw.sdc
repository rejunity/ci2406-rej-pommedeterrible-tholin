...
set_input_delay -min 16.5  -clock [get_clocks {clk}] [get_ports {dest_val0[*]}]
set_input_delay -min 16.5  -clock [get_clocks {clk}] [get_ports {dest_pred_val0[*]}]
set_input_delay -min 16.5  -clock [get_clocks {clk}] [get_ports {take_branch0[*]}]
set_input_delay -min 16.5  -clock [get_clocks {clk}] [get_ports {new_PC0[*]}]
set_input_delay -max 25  -clock [get_clocks {clk}] [get_ports {dest_val0[*]}]
set_input_delay -max 25  -clock [get_clocks {clk}] [get_ports {dest_pred_val0[*]}]
set_input_delay -max 25  -clock [get_clocks {clk}] [get_ports {take_branch0[*]}]
set_input_delay -max 25  -clock [get_clocks {clk}] [get_ports {new_PC0[*]}]
set_input_delay -min 16.5  -clock [get_clocks {clk}] [get_ports {dest_val1[*]}]
set_input_delay -min 16.5  -clock [get_clocks {clk}] [get_ports {dest_pred_val1[*]}]
set_input_delay -min 16.5  -clock [get_clocks {clk}] [get_ports {take_branch1[*]}]
set_input_delay -min 16.5  -clock [get_clocks {clk}] [get_ports {new_PC1[*]}]
set_input_delay -max 25  -clock [get_clocks {clk}] [get_ports {dest_val1[*]}]
set_input_delay -max 25  -clock [get_clocks {clk}] [get_ports {dest_pred_val1[*]}]
set_input_delay -max 25  -clock [get_clocks {clk}] [get_ports {take_branch1[*]}]
set_input_delay -max 25  -clock [get_clocks {clk}] [get_ports {new_PC1[*]}]
set_input_delay -min 16.5  -clock [get_clocks {clk}] [get_ports {dest_val2[*]}]
set_input_delay -min 16.5  -clock [get_clocks {clk}] [get_ports {dest_pred_val2[*]}]
set_input_delay -min 16.5  -clock [get_clocks {clk}] [get_ports {take_branch2[*]}]
set_input_delay -min 16.5  -clock [get_clocks {clk}] [get_ports {new_PC2[*]}]
set_input_delay -max 25  -clock [get_clocks {clk}] [get_ports {dest_val2[*]}]
set_input_delay -max 25  -clock [get_clocks {clk}] [get_ports {dest_pred_val2[*]}]
set_input_delay -max 25  -clock [get_clocks {clk}] [get_ports {take_branch2[*]}]
set_input_delay -max 25  -clock [get_clocks {clk}] [get_ports {new_PC2[*]}]
